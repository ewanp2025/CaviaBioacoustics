1. Introduction
This Privacy Policy applies to the Cavia Bioacoustics mobile application ("the App"), developed by Ewan Pettigrew. This policy explains our practices regarding the collection, use, and disclosure of information when you use the App.
